document.addEventListener('DOMContentLoaded', function() {
    (function() {
        // Sample arrays with links in array1
        let array1 = Array.from({length: 100}, (_, i) => `https://example.com/page${i + 1}`); // Links
        let array2 = Array.from({length: 100}, (_, i) => `https://picsum.photos/200/${300 + i}`); // Image URLs
        ...
        function loadMoreImages() {
            ...
            for (let i = currentIndex; i < endIndex; i++) {
                ...
                img.addEventListener('click', (e) => showClickAnimation(e, array1[i])); // Pass link to the animation function
        ...
        // Function to show click animation and load link after animation ends
        function showClickAnimation(event, link) {
            ...
            video.src = 'file:///C:/Users/bhans/Downloads/animation.webm'; // Update this path as needed
            video.autoplay = true;
            video.loop = false;
            ...
            // Load the link after the video ends
